...
interface InventoryService{
	...
	@GetMapping("/products")
	public PagedModel<Product> findAllPoducts();
}
...
public class BillingServiceApplication {
	...
	CommandLineRunner start(BillRepository billRepository,ProductItemRepository productItemRepository,
		...
		return args -> {
			...
			PagedModel<Product> products = inventoryService.findAllPoducts();
...
/*
		...
		//	productItemRepository.save(new ProductItem(null,p1.getId(),p1.getPrice(),30,bill1));
			...
			productItemRepository.save(new ProductItem(null,p4.getId(),p4.getPrice(),30,bill1));
*/
		};
	}
}
